...
```bash
echo "[meta] PLUGIN_ROOT=/Users/bytedance/Library/Caches/coco/plugins/coco-workflow" 1>&2
COCO_WF_BACKEND=traex node "/Users/bytedance/Library/Caches/coco/plugins/coco-workflow/runtime/cli.js" run "$1" --args='<把 Step 2 的 JSON 嵌这里>' --no-tui --events-ndjson 2>&1
```
...
<!-- coco-workflow:support-command source=/Users/bytedance/Library/Caches/coco/plugins/coco-workflow/commands/workflow.md -->
